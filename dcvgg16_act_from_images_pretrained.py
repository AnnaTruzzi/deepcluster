...
#    args = parser.parse_args()
    ...
    checkpoint = torch.load(modelpth+'checkpoint_vgg16.pth.tar')['state_dict']
    ...
    with open('/home/CUSACKLAB/annatruzzi/cichy2016/niko92_activations_pretrained_vgg16.pickle', 'wb') as handle:
